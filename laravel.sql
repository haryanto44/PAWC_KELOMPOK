...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2021 at 11:10 AM
...
CREATE TABLE `data_user` (
  ...
  `list_id_peminjaman` int(11) NOT NULL
...
INSERT INTO `list_buku` (`id`, `judul_buku`, `pengarang`, `penerbit`, `tahun_terbit`, `tebal_halaman`) VALUES
(1, 'God Explained in a Taxi Ride', 'Paul Arden', 'Perigee', '2009', 123),
(2, 'Judul buku 2', 'Mikael Blabla', 'Peri Gigi', '2009', 233),
(3, 'Bagaimana merebus air', 'Bukan Suratno', 'Kembang Gula', '2009', 212),
(4, 'Judul buku 4', 'Mikael Kordoba', 'Lebah Waras', '2010', 153);
